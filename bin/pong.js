...
xinf.xml.XMLElement.prototype.cacheTrait = function(name,v,type) {
	...
	this._ptraits[name] = v;
	return v;
}
xinf.xml.XMLElement.prototype.clearPresentationTraits = function() {
	this._ptraits = { }
}
...
xinf.xml.XMLElement.prototype.setTraitFromDynamic = function(name,value,to) {
	var def = this.getTraitDefinition(name);
	if(def != null) to[name] = def.fromDynamic(value);
	else to[name] = value;
}
xinf.xml.XMLElement.prototype.setTraitFromString = function(name,value,to) {
	var def = this.getTraitDefinition(name);
...
xinf.style.StyledElement.prototype.styleChanged = function(attribute) {
	this.clearPresentationTraits();
	{ var $it12 = this.get_childNodes();
...
xinf.ony.traits.TransformTrait.prototype.add = function(a,b) {
	return new xinf.geom.Concatenate(b,a);
}
...
xinf.ony.Element.prototype.getBoundingBox = function() {
	haxe.Log.trace("getBoundingBox unimplemented for " + this,{ fileName : "Element.hx", lineNumber : 163, className : "xinf.ony.Element", methodName : "getBoundingBox"});
...
xinf.ony.Element.prototype.get_fill_opacity = function() {
	return this.getStyleTrait("fill-opacity",Float);
}
xinf.ony.Element.prototype.get_font_family = function() {
	return this.getStyleTrait("font-family",xinf.ony.type.StringList);
}
xinf.ony.Element.prototype.get_font_size = function() {
	return this.getStyleTrait("font-size",xinf.ony.type.Length).value;
}
xinf.ony.Element.prototype.get_line_cap = function() {
	return this.getStyleTrait("stroke-linecap",xinf.ony.type.CapsStyle);
}
xinf.ony.Element.prototype.get_line_join = function() {
	return this.getStyleTrait("stroke-linejoin",xinf.ony.type.JoinStyle);
}
...
xinf.ony.Element.prototype.get_stroke_dasharray = function() {
	return this.getStyleTrait("stroke-dasharray",xinf.ony.type.IntList);
}
xinf.ony.Element.prototype.get_stroke_dashoffset = function() {
	return this.getStyleTrait("stroke-dashoffset",Int);
}
xinf.ony.Element.prototype.get_stroke_miterlimit = function() {
	return this.getStyleTrait("stroke-miterlimit",Float);
}
xinf.ony.Element.prototype.get_stroke_opacity = function() {
	return this.getStyleTrait("stroke-opacity",Float);
}
xinf.ony.Element.prototype.get_stroke_width = function() {
	return this.getStyleTrait("stroke-width",xinf.ony.type.Length).value;
}
xinf.ony.Element.prototype.get_text_anchor = function() {
	return this.getStyleTrait("text-anchor",xinf.ony.type.TextAnchor);
}
...
xinf.ony.Element.prototype.set_fill_opacity = function(v) {
	return this.setStyleTrait("fill-opacity",v);
}
xinf.ony.Element.prototype.set_font_family = function(v) {
	return this.setStyleTrait("font-family",v);
}
xinf.ony.Element.prototype.set_font_size = function(v) {
	return this.setStyleTrait("font-size",new xinf.ony.type.Length(null,v)).getValue();
}
...
xinf.ony.Element.prototype.set_line_cap = function(v) {
	return this.setStyleTrait("stroke-linecap",v);
}
xinf.ony.Element.prototype.set_line_join = function(v) {
	return this.setStyleTrait("stroke-linejoin",v);
}
...
xinf.ony.erno.Element.prototype.copyProperties = function(to) {
	xinf.ony.Element.prototype.copyProperties.apply(this,[to]);
}
xinf.ony.erno.Element.prototype.destroy = function() {
	if(this.xid != null) {
...
xinf.ony.erno.Group.prototype.appendChild = function(newChild) {
	if(newChild.parentElement != null) {
		newChild.parentElement.removeChild(newChild);
	}
	if(Std["is"](newChild,xinf.ony.erno.Element)) newChild.construct();
	return xinf.ony.Group.prototype.appendChild.apply(this,[newChild]);
}
xinf.ony.erno.Group.prototype.destroy = function() {
	xinf.ony.Group.prototype.destroy.apply(this,[]);
}
...
xinf.ony.erno.Group.prototype.removeChild = function(oldChild) {
	if(Std["is"](oldChild,xinf.ony.erno.Element)) oldChild.destroy();
	return xinf.ony.Group.prototype.removeChild.apply(this,[oldChild]);
}
...
xinf.ony.erno.Image.prototype.dataLoaded = function(e) {
	this.dataChanged(e);
	this.postEvent(e,{ fileName : "Image.hx", lineNumber : 35, className : "xinf.ony.erno.Image", methodName : "dataLoaded"});
}
...
xinf.ony.erno.Image.prototype.resolve = function() {
	...
	try {
		this.set_bitmap(xinf.ony.erno.Image.load(url.toString()));
	}
	catch( $e24 ) {
		{
			var e = $e24;
			{
				haxe.Log.trace(e,{ fileName : "Image.hx", lineNumber : 57, className : "xinf.ony.erno.Image", methodName : "resolve"});
			}
		}
	}
	this.redraw();
...
xinf.event.FrameEvent = function(_type,frame) { if( _type === $_ ) return; {
	xinf.event.Event.apply(this,[_type]);
	this.frame = frame;
}}
...
xinf.ony.PathParser.simplify = function(segments) {
	...
	var csmooth = null;
	var qsmooth = null;
	{ var $it35 = segments.iterator();
	while( $it35.hasNext() ) { var seg = $it35.next();
	{
		var csmooth2 = null;
		var qsmooth2 = null;
		var $e = (seg);
...
pong.ui.Keyboard.initialize = function() {
	xinf.ony.Root.addEventListener(xinf.event.KeyboardEvent.KEY_DOWN,$closure(pong.ui.Keyboard,"onKeyDown"));
	xinf.ony.Root.addEventListener(xinf.event.KeyboardEvent.KEY_UP,$closure(pong.ui.Keyboard,"onKeyUp"));
}
pong.ui.Keyboard.onKeyDown = function(e) {
	pong.ui.Keyboard._KEY.set(e.key.toUpperCase(),true);
}
pong.ui.Keyboard.onKeyUp = function(e) {
	pong.ui.Keyboard._KEY.set(e.key.toUpperCase(),false);
}
pong.ui.Keyboard.isDown = function(key) {
	if(pong.ui.Keyboard._KEY.exists(key.toUpperCase())) return pong.ui.Keyboard._KEY.get(key.toUpperCase());
	return false;
}
...
xinf.ony.erno.Path.prototype.drawContents = function(g) {
	...
	g.startShape();
	var open = false;
	{ var $it39 = this.get_segments().iterator();
...
pong.ui.Mouse.initialize = function() {
	xinf.ony.Root.addEventListener(xinf.event.MouseEvent.MOUSE_UP,$closure(pong.ui.Mouse,"onMouseUp"));
	xinf.ony.Root.addEventListener(xinf.event.MouseEvent.MOUSE_DOWN,$closure(pong.ui.Mouse,"onMouseDown"));
	xinf.ony.Root.addEventListener(xinf.event.MouseEvent.MOUSE_MOVE,$closure(pong.ui.Mouse,"onMouseMove"));
}
pong.ui.Mouse.onMouseMove = function(e) {
	pong.ui.Mouse.X = Math.floor(e.x);
	pong.ui.Mouse.Y = Math.floor(e.y);
}
pong.ui.Mouse.onMouseDown = function(e) {
	pong.ui.Mouse._BUTTON[e.button] = true;
}
pong.ui.Mouse.onMouseUp = function(e) {
	pong.ui.Mouse._BUTTON[e.button] = false;
}
pong.ui.Mouse.isDown = function(button) {
	if(pong.ui.Mouse._BUTTON[button] == true) return true;
	return false;
}
...
xinf.ony.erno.Manager.prototype.dispatchToTarget = function(e) {
	if(e.targetId != null) {
		...
		if(target != null) target.postEvent(e,{ fileName : "Manager.hx", lineNumber : 57, className : "xinf.ony.erno.Manager", methodName : "dispatchToTarget"});
	}
}
...
xinf.ony.erno.Manager.prototype.redrawChanged = function(e) {
	...
	this.changed = new IntHash();
	{ var $it41 = ch1.keys();
	while( $it41.hasNext() ) { var id = $it41.next();
	{
		ch1.get(id).draw(g);
		somethingChanged = true;
	}
...
xinf.style.StyleParser.parseToObject = function(text) {
	var to = { }
	text = xinf.style.StyleParser.comment.replace(text,"");
...
pong.Paddle.prototype.decay = function() {
	this.velocity.y *= .9;
}
...
xinf.ony.Polygon.prototype.get_points = function() {
	return this.getTrait("points",List);
}
...
pong.MainMenu = function(p) { if( p === $_ ) return; {
	var g = new pong.Game(xinf.ony.Root.width,xinf.ony.Root.height);
	xinf.ony.Root.appendChild(g);
	xinf.ony.Root.addEventListener(xinf.event.GeometryEvent.STAGE_SCALED,function(e) {
		g.setWidth(xinf.ony.Root.width);
		g.setHeight(xinf.ony.Root.height);
	});
}}
...
xinf.ony.Text.prototype.textContent = function(xml) {
	var text = "";
	{ var $it44 = xml.iterator();
	while( $it44.hasNext() ) { var child = $it44.next();
	{
		switch(child.nodeType) {
		case Xml.PCData:{
			text += child.getNodeValue();
	...
	return xinf.ony.Text.xmlUnescape(StringTools.trim(text));
}
...
xinf.geom.TransformList = function(list) { if( list === $_ ) return; {
	this.l = new List();
	if(list != null) { var $it45 = list.iterator();
	while( $it45.hasNext() ) { var item = $it45.next();
	this.l.add(item);
	}}
	this.cache();
}}
...
xinf.geom.TransformList.prototype.cache = function() {
	...
	{ var $it46 = this.l.iterator();
	while( $it46.hasNext() ) { var item = $it46.next();
	{
...
xinf.geom.TransformList.prototype.toString = function() {
	var r = "(*";
	{ var $it47 = this.l.iterator();
	while( $it47.hasNext() ) { var item = $it47.next();
	{
		r += "," + item;
	}
	}}
...
xinf.style.StyleSheet.prototype.addMany = function(_rules) {
	{ var $it48 = _rules.iterator();
	while( $it48.hasNext() ) { var rule = $it48.next();
	this.add(rule);
	}}
}
...
haxe.Http.prototype.request = function(post) {
	...
	while( $it50.hasNext() ) { var p = $it50.next();
	{
		if(uri == null) uri = "";
		else uri += "&";
	...
	{ var $it52 = this.headers.keys();
	while( $it52.hasNext() ) { var h = $it52.next();
...
pong.Game = function(width_,height_) { if( width_ === $_ ) return; {
	...
	xinf.ony.Root.addEventListener(xinf.event.FrameEvent.ENTER_FRAME,$closure(this,"render"));
...
pong.Game.__super__ = xinf.ony.erno.Group;
for(var k in xinf.ony.erno.Group.prototype ) pong.Game.prototype[k] = xinf.ony.erno.Group.prototype[k];
...
pong.Game.prototype._pause = null;
...
pong.Game.prototype.getPause = function() {
	return this._pause;
}
...
pong.Game.prototype.newRound = function() {
	this._leftPaddle.y = this._height / 2 - this._leftPaddle.height / 2;
	this._rightPaddle.y = this._height / 2 - this._rightPaddle.height / 2;
	this._ball.y = this._height / 2 - this._ball.height / 2;
	this._ball.x = this._width / 2 - this._ball.width / 2;
	this._ball.velocity.x = this._width * Math.random() - this._width * 0.5;
	this._ball.velocity.y = this._height * Math.random() - this._height * 0.5;
	this._ball.velocity = this._ball.velocity.normalize(this._width * 0.01);
}
pong.Game.prototype.pause = null;
...
pong.Game.prototype.render = function(e) {
	this._ball.display.set_x(this._ball.x + this._x);
	this._ball.display.set_y(this._ball.y + this._y);
	this._leftPaddle.display.set_x(this._leftPaddle.x + this._x);
	this._leftPaddle.display.set_y(this._leftPaddle.y + this._y);
	this._rightPaddle.display.set_x(this._rightPaddle.x + this._x);
...
pong.Game.prototype.setPause = function(v) {
	this._pause = v;
	if(this._pause) this._physicsTicker.stop();
	else this._physicsTicker.run = $closure(this,"physicsStep");
	return v;
}
...
pong.Game.prototype.setY = function(v) {
	this._y = v;
	this._backGround.set_y(this._y);
	this._leftScoreLabel.set_y(10 + this._y);
	this._rightScoreLabel.set_y(10 + this._y);
	return v;
}
pong.Game.prototype.setupStage = function() {
	this._backGround = new xinf.ony.erno.Rectangle({ width : this._width, height : this._height, fill : xinf.ony.type.Paint.RGBColor(0.1,0.1,0.1)});
...
xinf.erno.js.JSRuntime.prototype.step = function() {
	this.postEvent(new xinf.event.FrameEvent(xinf.event.FrameEvent.ENTER_FRAME,this.frame++),{ fileName : "JSRuntime.hx", lineNumber : 36, className : "xinf.erno.js.JSRuntime", methodName : "step"});
}
...
xinf.xml.URL.prototype.getRelativeURL = function(rel) {
	var url = new xinf.xml.URL(this.pathString() + rel);
	return url;
}
...
xinf.ony.Element.TRAITS = { transform : new xinf.ony.traits.TransformTrait(), display : new xinf.traits.EnumTrait(xinf.ony.type.Display,null,xinf.ony.type.Display.Inline), visibility : new xinf.traits.EnumTrait(xinf.ony.type.Visibility,null,xinf.ony.type.Visibility.Visible), opacity : new xinf.traits.BoundedFloatTrait(0,1,1), color : new xinf.ony.traits.PaintTrait(null), fill : new xinf.ony.traits.PaintTrait(xinf.ony.type.Paint.None), fill_opacity : new xinf.traits.BoundedFloatTrait(0,1,1), stroke : new xinf.ony.traits.PaintTrait(xinf.ony.type.Paint.None), stroke_width : new xinf.ony.traits.LengthTrait(new xinf.ony.type.Length(null,1)), stroke_opacity : new xinf.traits.BoundedFloatTrait(0,1,1), stroke_linejoin : new xinf.traits.EnumTrait(xinf.ony.type.JoinStyle,"join",xinf.ony.type.JoinStyle.MiterJoin), stroke_linecap : new xinf.traits.EnumTrait(xinf.ony.type.CapsStyle,"caps",xinf.ony.type.CapsStyle.ButtCaps), stroke_miterlimit : new xinf.traits.FloatTrait(4), stroke_dasharray : new xinf.ony.traits.IntListTrait(), stroke_dashoffset : new xinf.traits.IntTrait(), font_family : new xinf.ony.traits.StringListTrait(), font_size : new xinf.ony.traits.LengthTrait(new xinf.ony.type.Length(null,10)), font_weight : new xinf.ony.traits.StringChoiceTrait(["normal","bold"]), text_anchor : new xinf.traits.EnumTrait(xinf.ony.type.TextAnchor,"",xinf.ony.type.TextAnchor.Start)}
...
pong.ui.Keyboard._KEY = new Hash();
...
pong.ui.Mouse._BUTTON = new Array();
pong.ui.Mouse.X = 0;
pong.ui.Mouse.Y = 0;
...
xinf.style.StyleParser.comment = new EReg("/\\*[^\\*]*\\*/","g");
...
pong.Paddle.HUMAN = 0;
pong.Paddle.EASY_AI = 1;
pong.Paddle.MEDIUM_AI = 2;
pong.Paddle.HARD_AI = 3;
